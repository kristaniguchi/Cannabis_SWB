...
model_data <- read.csv("Elk_River/elk_subbasins_tlaps_rates.sub_cfs.csv", check.names = F) 
...
dir.create("FFC_outputs/Elk_River/boxplots/", recursive=TRUE)
dir.create("FFC_outputs/Elk_River/csv_results/", recursive=TRUE)
dir.create("FFC_outputs/Elk_River/FFM_eval/", recursive=TRUE)
dir.create("FFC_outputs/Elk_River/residuals/", recursive=TRUE)
dir.create("FFC_outputs/Elk_River/scatterplots/", recursive=TRUE)
#create subfolders for plots
dir.create("FFC_outputs/Elk_River/boxplots/reference_calibration/", recursive=TRUE)
dir.create("FFC_outputs/Elk_River/residuals/reference_calibration/", recursive=TRUE)
dir.create("FFC_outputs/Elk_River/scatterplots/reference_calibration/", recursive=TRUE)
dir.create("FFC_outputs/Elk_River/boxplots/validation_impaired/", recursive=TRUE)
dir.create("FFC_outputs/Elk_River/residuals/validation_impaired/", recursive=TRUE)
dir.create("FFC_outputs/Elk_River/scatterplots/validation_impaired/", recursive=TRUE)


write.csv(export.gage, paste("FFC_outputs/Elk_River/csv_results/", Model_Watershed_eval, "_gage_", "ffc_results_", today(),".csv", sep = ""), row.names = F)
...
write.csv(export.model, paste("FFC_outputs/Elk_River/csv_results/", Model_Watershed_eval, "_model_rev2_", "ffc_results_", today(),".csv", sep = ""), row.names = F)
...
for(p in 1:length(gage_list)){
  ...
  for (y in 1:length(unique.component)){
    ...
    if(gage.type.p == "Reference"){ #using updated Type2 column from Kris' table
      ggsave(file = paste("FFC_outputs/Elk_River/boxplots/reference_calibration/", Model_Watershed_eval,"_", gageID.p2,"_",unique(df.2$title_component),"_boxplot.jpg",sep = ""), 
             width = 180, height = 180, unit = "mm", dpi = 300, boxplot)
    }else if(gage.type.p == "Validation" & gage.validation.notes.p == "Impaired"){ 
      ggsave(file = paste("FFC_outputs/Elk_River/boxplots/validation_impaired/", 
      ...
      ggsave(file = paste("FFC_outputs/Elk_River/boxplots/validation_non-impaired/", Model_Watershed_eval,"_", gageID.p2,"_",unique(df.2$title_component),"_boxplot.jpg",sep = ""), 
...
for(r in 1:length(gage_list)){
  ...
  for (z in 1:length(unique.component)){
    ...
    #saving scatter plots
      ...
      ggsave(file = paste("FFC_outputs/Elk_River/scatterplots/reference_calibration/", Model_Watershed_eval,"_", gageID.r,"_",unique(df.2$title_component),"_scatterplot.jpg",sep = ""), 
             width = 180, height = 180, unit = "mm", dpi = 300, scatter_plot)
    }else if(gage.type.r == "Validation" & validation.notes.r == "Impaired"){ 
      ggsave(file = paste("FFC_outputs/Elk_River/scatterplots/validation_impaired/", 
                          Model_Watershed_eval,"_", gageID.r,"_",unique(df.2$title_component),"_scatterplot.jpg",sep = ""), 
             width = 180, height = 180, unit = "mm", dpi = 300, scatter_plot)
      #else it's validation non-reference (minimally impaired) and reference
    }else{  
      ggsave(file = paste("FFC_outputs/Elk_River/scatterplots/validation_non-impaired/", Model_Watershed_eval,"_", gageID.r,"_",unique(df.2$title_component),"_scatterplot.jpg",sep = ""), 
    ...
    residual_plot <- ggplot(df.2, aes(x = gage.value, y = residual))+
      ...
      subtitle = paste0("Gage Name:", gage.name.r, ", Gage ID:", gageID.r, ", Model ID:", modelID.r))
        ...
        if(gage.type.r == "Reference"){ #using updated Type2 column from Kris' table
      ggsave(file = paste("FFC_outputs/Elk_River/residuals/reference_calibration/", Model_Watershed_eval,"_", gageID.r,"_",unique(df.2$title_component),"_residualplot.jpg",sep = ""), 
             width = 180, height = 180, unit = "mm", dpi = 300, residual_plot)
    }else if(gage.type.r == "Validation" & validation.notes.r == "Impaired"){ 
      ggsave(file = paste("FFC_outputs/Elk_River/residuals/validation_impaired/", 
                          Model_Watershed_eval,"_", gageID.r,"_",unique(df.2$title_component),"_residualplot.jpg",sep = ""), 
             width = 180, height = 180, unit = "mm", dpi = 300, residual_plot)
      #else it's validation non-reference (minimally impaired) and reference
    }else{  
      ggsave(file = paste("FFC_outputs/Elk_River/residuals/validation_non-impaired/", Model_Watershed_eval,"_", gageID.r,"_",unique(df.2$title_component),"_residualplot.jpg",sep = ""), 
